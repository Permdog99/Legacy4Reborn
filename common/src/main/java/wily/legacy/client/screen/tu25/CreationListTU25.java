    ...
    public CreationListTU25() {
        ...
        LegacyWorldTemplate.list.forEach(t-> addIconButton(this,t.icon(),t.buttonName(), c-> {
            try {
                ...
                if (t.directJoin()) LoadSaveScreenTU25.loadWorld(screen,minecraft,Legacy4JClient.currentWorldSource,name);
                else {
                    ...
                    access.close();
                    minecraft.setScreen(new LoadSaveScreenTU25(screen,summary,access));
                }
            } catch (IOException e) {
