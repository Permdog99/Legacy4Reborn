...
public class HelpOptionsScreen extends RenderableVListScreen {
    ...
    public HelpOptionsScreen(Screen parent) {
        ...
        if (((LegacyOptions) minecraft.options).developerMode().get()) {
            renderableVList.addRenderable(openScreenButton(Component.translatable("legacy.menu.developersettings"),()->prepareDeveloperSettings(new PanelVListScreenNoTitle(this,180,248,Component.translatable("legacy.menu.developersettings"), minecraft.options.autoJump(),minecraft.options.bobView(),((LegacyOptions)minecraft.options).flyingViewRolling(),minecraft.options.toggleSprint(),((LegacyOptions)minecraft.options).displayNameTagBorder(),((LegacyOptions)minecraft.options).legacyCreativeBlockPlacing(),minecraft.options.realmsNotifications(), minecraft.options.allowServerListing(), minecraft.options.biomeBlendRadius(), minecraft.options.prioritizeChunkUpdates(), minecraft.options.simulationDistance(),((LegacyOptions)minecraft.options).overrideTerrainFogStart(),((LegacyOptions)minecraft.options).terrainFogStart(),((LegacyOptions)minecraft.options).terrainFogEnd(), minecraft.options.bobView(), minecraft.options.gamma(),minecraft.options.cloudStatus(), minecraft.options.particles(), minecraft.options.mipmapLevels(), minecraft.options.entityShadows(), minecraft.options.screenEffectScale(), minecraft.options.entityDistanceScaling(), minecraft.options.fov(),minecraft.options.fovEffectScale(),minecraft.options.darknessEffectScale(),minecraft.options.glintSpeed(), minecraft.options.glintStrength(), ((LegacyOptions)minecraft.options).displayHUD(),((LegacyOptions)minecraft.options).displayHand(),minecraft.options.showAutosaveIndicator(),((LegacyOptions)minecraft.options).showVanillaRecipeBook(),minecraft.options.attackIndicator(),((LegacyOptions)minecraft.options).hudDistance(),((LegacyOptions)minecraft.options).inGameTooltips(),((LegacyOptions)minecraft.options).legacyItemTooltips(),((LegacyOptions)minecraft.options).vignette(),((LegacyOptions)minecraft.options).forceYellowText(),((LegacyOptions)minecraft.options).animatedCharacter(),((LegacyOptions)minecraft.options).smoothAnimatedCharacter(), ((LegacyOptions)minecraft.options).legacyCreativeTab(),((LegacyOptions)minecraft.options).vanillaTabs(), minecraft.options.operatorItemsTab(), minecraft.options.narrator(), minecraft.options.highContrast(), minecraft.options.notificationDisplayTime(), minecraft.options.damageTiltStrength(), minecraft.options.glintSpeed(), minecraft.options.glintStrength(), minecraft.options.hideLightningFlash(), minecraft.options.darkMojangStudiosBackground(), minecraft.options.panoramaSpeed(), minecraft.options.narratorHotkey(),minecraft.options.chatVisibility(), minecraft.options.chatColors(), minecraft.options.chatLinks(), minecraft.options.chatLinksPrompt(),  minecraft.options.backgroundForChatOnly(), minecraft.options.chatOpacity(), minecraft.options.textBackgroundOpacity(), minecraft.options.chatScale(), minecraft.options.chatLineSpacing(), minecraft.options.chatDelay(), minecraft.options.chatWidth(), minecraft.options.chatHeightFocused(), minecraft.options.chatHeightUnfocused(), minecraft.options.narrator(), minecraft.options.autoSuggestions(), minecraft.options.hideMatchedNames(), minecraft.options.reducedDebugInfo(), minecraft.options.onlyShowSecureChat()))).build());
        }
        this.parent = parent;
    }
