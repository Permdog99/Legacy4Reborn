...
import wily.legacy.client.screen.compat.FriendsServerRenderableListTU25;
...
public class PlayGameScreenTU25 extends PanelVListScreen implements ControlTooltip.Event, RenderableVList.Access{
    ...
    protected final ServerRenderableListTU25 ServerRenderableListTU25 = PublishScreen.hasWorldHost() ? new FriendsServerRenderableListTU25() : new ServerRenderableListTU25();
    public final SaveRenderableListTU25 saveRenderableList;
    private final CreationListTU25 CreationListTU25 = new CreationListTU25();
    @Override
    public void addControlTooltips(ControlTooltip.Renderer renderer) {
        ...
        renderer.add(()-> ControlType.getActiveType().isKbm() ? ControlTooltip.getKeyIcon(InputConstants.KEY_O) : ControllerBinding.UP_BUTTON.bindingState.getIcon(),()->saveOptions.get() || ServerRenderableListTU25.renderables.stream().anyMatch(r-> ServerRenderableListTU25.renderables.indexOf(r) > 1 && r instanceof GuiEventListener l && l.isFocused()) ? getAction(saveOptions.get() ? "legacy.menu.save_options" : "legacy.menu.server_options") : null);
    ...
    public PlayGameScreenTU25(Screen parent, int initialTab) {
        super(s-> Panel.centered(s,300,256,0,12),Component.translatable("legacy.menu.play_game"));
        this.parent = parent;
        tabList.selectedTab = initialTab;
        saveRenderableList = new SaveRenderableListTU25(this);
    }
    public PlayGameScreenTU25(Screen parent) {
        this(parent,0);
    }
    protected boolean canNotifyOnlineFriends(){
        return ServerRenderableListTU25.hasOnlineFriends() && Util.getMillis() % 1000 < 500;
    }

    @Override
    public void added() {
        super.added();
        ServerRenderableListTU25.added();
    }
    ...
    public RenderableVList getRenderableVList() {
        if (tabList.selectedTab == 2) return ServerRenderableListTU25;
        else if (tabList.selectedTab == 1) return CreationListTU25;
    ...
    public void removed() {
        ...
        ServerRenderableListTU25.removed();
    ...
    public void tick() {
        ...
        List<LanServer> list = ServerRenderableListTU25.lanServerList.takeDirtyServers();
        if (list != null) {
            if (ServerRenderableListTU25.lanServers == null || !new HashSet<>(ServerRenderableListTU25.lanServers).containsAll(list)) {
                ServerRenderableListTU25.lanServers = list;
                ServerRenderableListTU25.updateServers();
                rebuildWidgets();
            }
        }
        this.pinger.tick();
    ...
    public boolean keyPressed(int i, int j, int k) {
        ...
        if (i == 294) {
            if (tabList.selectedTab == 0) {
                ...
                ServerRenderableListTU25.servers.load();
                ServerRenderableListTU25.updateServers();
            }
            this.rebuildWidgets();
            return true;
    ...
    public ServerList getServers() {
        return ServerRenderableListTU25.servers;
    }
