...
public class SettingsScreenTU25 extends RenderableVListScreen {

    public SettingsScreenTU25(Screen parent) {
        super(parent,Component.translatable("legacy.menu.settings"), r->{});
        renderableVList.addRenderable(openScreenButton(Component.translatable("legacy.menu.game_options"), ()-> prepareGameOptionsScreen(new PanelVListScreen(this,250,182,Component.translatable("legacy.menu.game_options"),minecraft.options.autoJump(),minecraft.options.bobView(),((LegacyOptions)minecraft.options).flyingViewRolling(),((LegacyOptions)minecraft.options).unfocusedInputs(),minecraft.options.toggleCrouch(),minecraft.options.toggleSprint(),((LegacyOptions)minecraft.options).hints(),((LegacyOptions)minecraft.options).displayNameTagBorder(),((LegacyOptions)minecraft.options).autoSaveInterval(),((LegacyOptions)minecraft.options).autoSaveWhenPaused(),((LegacyOptions)minecraft.options).directSaveLoad(),((LegacyOptions)minecraft.options).legacyCreativeBlockPlacing(),((LegacyOptions)minecraft.options).cursorMode(),minecraft.options.sensitivity(),minecraft.options.realmsNotifications(), minecraft.options.allowServerListing(), ((LegacyOptions)minecraft.options).developerMode()),minecraft)).build());
