...
public record Assort(String id, int version, Component displayName, Component description, Optional<ResourceLocation> iconSprite, Optional<ResourceLocation> backgroundSprite, List<String> packs) {
    ...
    public static final Assort MINECRAFT = registerDefaultResource("minecraft",Component.translatable("legacy.menu.assorts.minecraft"),Component.translatable("legacy.menu.assorts.minecraft.description"),new ResourceLocation(Legacy4J.MOD_ID,"icon/minecraft"),new ResourceLocation(Legacy4J.MOD_ID,"icon/background"), Legacy4JPlatform.getMinecraftResourceAssort());
