...
import wily.legacy.client.screen.tu25.LoadSaveScreenTU25;
...
public class WorldMoreOptionsScreenTU25 extends PanelVListScreen implements ControlTooltip.Event{
    ...
    public WorldMoreOptionsScreenTU25(CreateWorldScreen parent, Consumer<Boolean> setTrustPlayers) {
    ...
    public WorldMoreOptionsScreenTU25(LoadSaveScreenTU25 parent) {
        super(parent,244, 199, Component.translatable("createWorld.tab.more.title"));
        tabList.selectedTab = 1;
        GameRules gameRules = parent.summary.getSettings().gameRules();
        LoadSaveScreenTU25.RESETTABLE_DIMENSIONS.forEach(d-> renderableVList.addRenderable(new TickBox(0,0,false, b-> Component.translatable("legacy.menu.load_save.reset",ScreenUtil.getDimensionName(d)), b-> null, t-> {
